...
A simple tool to download files from [Ufora](https://ufora.ugent.be/) (Brightspace) automatically using the [BrightSpace API](https://docs.valence.desire2learn.com/reference.html).
